...
export const mockVotes: Vote[] = [
  ...
  { pollId: "p2", userId: "u7", value: "Macht seine Arbeit sehr gut" },
  { pollId: "p2", userId: "u9", value: "Ist sehr gut" },
  {
    pollId: "p2",
    userId: "u2",
    value: "Könnte mehr auf die Mitarbeiter eingehen",
  },
  { pollId: "p2", userId: "u10", value: "Grüßt manchmal nicht" },
  { pollId: "p2", userId: "u14", value: "Oft genervt" },
